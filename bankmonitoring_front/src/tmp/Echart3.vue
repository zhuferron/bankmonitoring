<template>
  <div class="com-comtainer" @dblclick="revertMap">
    <div class="com-chart" ref="echart3"></div>
  </div>
...
export default {
  ...
  methods:{
    async initChart(){
      this.chartInstance = this.$echarts.init(this.$refs.echart3,'chalk')
    ...
    screenAdapter() {
      // 当前比较合适的字体大小
      const titleFontSize = (this.$refs.echart3.offsetWidth / 100) * 3.6
