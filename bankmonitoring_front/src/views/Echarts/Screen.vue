  ...
  <div class="screen-container" >
    <header class="screen-header">
      ...
      <div class="title-right">
        <div class="datetime">2021-06-25</div>
      </div>
    </header>
    <div class="screen-body">
      ...
      <section class="screen-middle" >
        <div id="middle-top" :class="[fullScreenStatus.echart3 ? 'fullscreen':'']">
          <Echart3 ref="echart3"></Echart3>
          <div class="resize">
            <span @click="changeSize('echart3')" :class="['iconfont', fullScreenStatus.echart3 ? 'icon-compress-alt' : 'icon-expand-alt']"></span>
          </div>
        </div>
